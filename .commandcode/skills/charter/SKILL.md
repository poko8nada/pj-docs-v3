...
when_to_use: 'チャーター, charterし, 方針を決め, 方針決め, 方針をまとめ, 提案をまとめ, 方針まとめ, 提案まとめ'
---
...
- Header validation and drift detection are handled by the header gate and the drift-gate checks.
